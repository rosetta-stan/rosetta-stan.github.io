...
# 'r2jags' no results
# 'nimble' is very low count
packages <- c('rjags','rstan','rstanarm','shinystan','loo','bayesplot','rstantools')
...
# )
# 
# all$package = rep('all',nrow(all))
# dls_all = rbind(dls,all)
...
pkg_query <- c('mc-stan.org',        'rstan', 'rstanarm','pymc3',
